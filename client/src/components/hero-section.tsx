    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-20 z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div
            className="inline-flex items-center bg-white/50 backdrop-blur-sm px-4 py-2 rounded-full mb-8 border border-primary/20"
          ...
          >
            VibeJoy uses cutting-edge AI to connect employers with freelancers
            based on skills, experience, and cultural fit. Skip the endless
            searching – let intelligence do the work.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Link href="/jobs" data-testid="button-browse-jobs">
              <Button
                variant="outline"
                className="bg-white text-primary px-8 py-4 rounded-lg font-semibold text-lg border border-primary hover:bg-primary/5 transition-colors"
              >
